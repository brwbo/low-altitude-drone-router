...
export default function MapView() {
  ...
  function drawRoute(route, cls) {
    ...
    const color = cls === "route-amber" ? "#ffb020" : "#3b9bff";
  ...
  async function compute() {
    ...
    try {
      if (mode === "compare") {
        ...
        setLive(data.live);
        if (data.error) { setError(data.error); clearExposure(); clearShadow(); clearBuildings(); clearContours(); setStats(null); setSun(null); return; }
